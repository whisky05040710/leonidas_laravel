                    ...
                    <section class="comp-section comp-cards">
                        <div class="row">
                            @foreach ($categories as $category)
                                ...
                                <div class="modal fade" id="inventorycategory-{{ $category->id }}" tabindex="-1"
                                    aria-labelledby="menuTitle" aria-hidden="true">
                        ...
                        <form action="/inventory/inventoryCategory" method="post">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group text-center">
                                        <div class="modal-box-report">
                                            <input type="text" class="form-control" id="categoryInput" name="name"
