            ...
            <div class="card">
                <div class="card-body">
                    <section class="comp-section comp-cards">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 d-flex" data-bs-toggle="modal"
                                ...
                                <div class="card flex-fill bg-white">
                                    <div class="card-header d-flex align-items-center justify-content-center"
                                        style="border: 1px solid black; background-color:#4dcc4b; ">
                                        <h4 class="card-title mb-0">Lunchdfvdf</h4>
                                    </div>
                                    <div class="card-body d-flex align-items-center justify-content-center"
                                        style="border: 1px solid black;">
                                        <h1 class="card-text mb-0">15</h1>
                        ...
                        <div class="modal fade" id="menucategory" tabindex="-1" aria-labelledby="menuTitle"
                            aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #EDEDED; text-align: center;">
                                        <div class="d-flex align-items-center justify-content-center flex-column w-100">
                                            ...
                                            <input type="text" class="form-control align-self-center mt-2"
                                                id="editMenuTitle"
                                        ...
                                        <div class="mt-2 text-center">
                                            <button type="button" class="btn btn-secondary me-2" id="editButton"
                                                onclick="editMenuTitle()" style="background-color: #4dcc4b;"><i
                                                ...
                                                <div class="form-group text-center">
                                                    <div class="modal-box-report">
                                                        ...
                                                        <ol
                                                            ...
                                                            <li>Salmon Teriyaki Bowl</li>
                                                            <li>Classic Margherita Pizza</li>
                                                            <li>Quinoa and Black Bean Burrito</li>
                                                            <li>Shrimp Scampi Linguine</li>
                                                            <li>Caprese Sandwich</li>
                                                            <li>Beef and Broccoli Stir-Fry</li>
