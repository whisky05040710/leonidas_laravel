                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="box-order" href="#" data-bs-toggle="modal"
                                                            ...
                                                            <div class="order-details">
                                                                <p>
                                                                    <strong>Customer Name:</strong><br> Francis Joe
                                                                    Pilarmeo<br>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-submit">Order Served</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="order2" tabindex="-1" aria-hidden="true" style="display: none">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-submit">Order Completed</button>
                </div>
            </div>
        </div>
    </div>
